...
const updateData = ref<PublicFormData>({header:'',content:'',date:'',image:null,_id:''})
...
<template>
  <over-lay-loader v-if="processing" />
    <div class="flex items-center justify-between">
      ...
      <base-button type="submit" customBg="bg-green-600" class="mt-4 text-center hover:bg-green-700 duration-300 transition-all" @click="showInfo({header:'',content:'',date:'',image:null,_id:''})">Create</base-button>
    </div>
